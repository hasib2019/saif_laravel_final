                            ...
                            <div class="hero-article position-relative">
                                <div class="hero-image">
                                    @if ($mainFeatured->images && count($mainFeatured->images) > 0)
                                        <img src="{{ asset($mainFeatured->images[0]) }}" alt="{{ $mainFeatured->title }}"
                                            ...
                                            <div class="col-5">
                                                @if ($featured->images && count($featured->images) > 0)
                                                    <img src="{{ asset($featured->images[0]) }}"
                                                        alt="{{ $featured->title }}" class="w-100 h-100 object-cover">
                                                @else
                                                    <div
                                                        class="placeholder-img d-flex align-items-center justify-content-center h-100">
                    ...
                    <form method="GET" action="{{ route('news.search') }}" class="mb-4">
                        <div class="input-group">
                            <input type="text" name="q" class="form-control"
                                placeholder="{{ __('Search news articles...') }}" value="{{ request('search') }}">
                                ...
                                <div class="card h-100 border-0 shadow-sm">
                                    @if ($article->images && count($article->images) > 0)
                                        <div class="card-img-container">
                                            <img src="{{ asset($article->images[0]) }}" alt="{{ $article->title }}"
                                                ...
                                                @if ($latest->images && count($latest->images) > 0)
                                                    <div class="col-4">
                                                        <img src="{{ asset($latest->images[0]) }}"
                                                            alt="{{ $latest->title }}" class="w-100 rounded sidebar-img">
                                                    </div>
                                                    <div class="col-8">
                                                    @else
                                                        <div class="col-12">
